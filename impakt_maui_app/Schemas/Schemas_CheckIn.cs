...
namespace impakt_maui_app.Schemas
{
    ...
    public class Req_Statistics_Admin_CheckInsByType_All
    {
        public DateTime date_time_min { get; set; }
        public DateTime date_time_max { get; set; }
    }

    public class Resp_Statistics_Admin_CheckInsByType
    {
        ...
        public int entries_multisport { get; set; }
        public int entries_other { get; set; }
